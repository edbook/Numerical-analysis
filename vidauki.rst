...
| Dags.    | Efni                             | Kaflar    |
+==========+==================================+===========+
| 08.01.16 | 1\. Inngangur                    | 2.1-2.4   |
+----------+----------------------------------+-----------+
| 13.01.16 | 2\. Núllstöðvar: samfelldni      | 2.5-2.8   |
+          +                                  +           +
| 15.01.16 | 2.\ Núllstöðvarg samfelldni      | 2.9-2.10  |
+          +                                  +           +
| \-       | **Heimadæmi 1**                  | \-        |
+----------+----------------------------------+-----------+
| 20.01.16 | 3\. Afleiður                     | 3.1-3.3   |
+          +                                  +           +
| 22.01.16 | 3\. Afleiður                     | 3.4-3.6   |
+          +                                  +           +
| \-       | **Heimadæmi 2**                  | \-        |
+----------+----------------------------------+-----------+
| 27.01.16 | 3\. Afleiður                     | 3.7-3.10  |
+          +                                  +           +
| 29.01.16 | 3\. Afleiður                     | 3.11-3.13 |
+          +                                  +           +
| \-       | **Heimadæmi 3**                  | \-        |
| \-       | **Verkefni I kynnt**             | \-        |
+----------+----------------------------------+-----------+
| 03.02.16 | 4\. Torræð föll                  | 4.1-4.4   |
+          +                                  +           +
| 05.02.16 | 4\. Torræð föll                  | 4.5-4.7   |
+          +                                  +           +
| \-       | **Heimadæmi 4**                  | \-        |
+----------+----------------------------------+-----------+
| 10.02.16 | 5\. Könnun falla                 | 5.1-5.3   |
+          +                                  +           +
| 12.02.16 | 5\. Könnun falla                 | 5.4-5.6   |
+          +                                  +           +
| \-       | **Verkefni I skilað**            | \-        |
+----------+----------------------------------+-----------+
| 17.02.16 | 5\. Könnun falla                 | 5.7-5.8   |
+          +                                  +           +
| 19.02.16 | 6.\ Heildun                      | 6.1-6.3   |
+          +                                  +           +
| \-       | **Heimadæmi 5**                  | \-        |
+----------+----------------------------------+-----------+
| 24.02.16 | 6\. Heildun                      | 6.4-6.5   |
+          +                                  +           +
| 26.02.16 | 6\. Heildun                      | 6.6       |
+          +                                  +           +
| \-       | **Heimadæmi 6**                  | \-        |
| \-       | **Verkefni II kynnt**            | \-        |
+----------+----------------------------------+-----------+
| 02.03.16 | 6\. Heildun                      | 6.7       |
+          +                                  +           +
| 04.03.16 | 7\. Rúmmál, massi og massamiðjur | 7.1       |
+          +                                  +           +
| \-       | **Heimadæmi 7**                  | \-        |
+----------+----------------------------------+-----------+
| 09.03.16 | 7\. Rúmmál, massi og massamiðjur | 7.2-7.3   |
+          +                                  +           +
| 11.03.16 | 8\. Diffurjöfnur                 | 8.1-8.2   |
+          +                                  +           +
| \-       | **Verkefni II skilað**           | \-        |
+----------+----------------------------------+-----------+
| 16.03.16 | 8\. Diffurjöfnur                 | 8.3-8.5   |
+          +                                  +           +
| 18.03.16 | Hagnýtingar                      | \-        |
+          +                                  +           +
| \-       | **Heimadæmi 8**                  | \-        |
+----------+----------------------------------+-----------+
| 23.03.16 | *Páskafrí*                       |           |
...
| 25.03.16 | *Páskafrí*                       |           |
+----------+----------------------------------+-----------+
| 30.03.16 | 10\. Veldaraðir                  | 10.1      |
+          +                                  +           +
| 01.04.16 | 10\. Veldaraðir                  | 10.2      |
+          +                                  +           +
| \-       | **Heimadæmi 9**                  | \-        |
+----------+----------------------------------+-----------+
| 06.04.16 | 10\. Veldaraðir                  | 10.3      |
+          +                                  +           +
| 08.04.16 | Samantekt og prófundirbúningur   | \-        |
+          +                                  +           +
| \-       | **Heimadæmi 10**                 | \-        |
+----------+----------------------------------+-----------+
| 13.04.16 | 10\. Veldaraðir                  | 10.3      |
+          +                                  +           +
| 15.04.16 | Samantekt og prófundirbúningur   | \-        |
+----------+----------------------------------+-----------+
| 20.04.16 | Samantekt og prófundirbúningur   | \-        |
+----------+----------------------------------+-----------+
...
Kennari er: Benedikt Steinar Magnússon.
...
Vikublöð:Vikublöð verða sett í möppuna *Vikublöð* á Uglu á föstudögum. Á þeim er að finna lista yfir viðfangsefni og heimadæmi næstu viku.

Heimadæmi og dæmatímar
~~~~~~~~~~~~~~~~~~~~~~

Dæmatímarnir í námskeiðunu verða notaðir bæði til að reikna dæmi á töflu og sem stoðtímar fyrir heimadæmin. Alls verða lögð fyrir 10 heimadæmi. Þeim á að skila á föstudögum fyrir klukkan 16:00 í hólf viðkomandi dæmatímakennara. Heimadæmin er að finna á vikublöðum sem verða sett í möppuna *Vikublöð* á Uglu. 
...
Þau ykkar sem hafa prófrétt frá síðasta ári haldið verkefnaeinkunn. En þið þurfið bara að tilkynna mér það með tölvupósti sem fyrst.
