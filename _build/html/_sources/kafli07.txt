Jaðargildisverkefni fyrir venjulegar afleiðujöfnur
==================================================
...
| Athugið að blönduð jaðarskilyrði með :math:`\alpha_2=0` (eða
  :math:`\beta_2=0`)
| er Dirichlet skilyrði með :math:`\alpha=\alpha_3/\alpha_1` (eða
  :math:`\beta=\beta_3/\beta_1`).

| Athugið að blandað jaðarskilyrði með :math:`\alpha_1=0` (eða
  :math:`\beta_1=0`)
| er Neumann skilyrði með :math:`\alpha=\alpha_3/\alpha_2` (eða
  :math:`\beta=\beta_3/\beta_2`).

Línulegar jöfnur – Dirichlet-jaðarskilyrði
------------------------------------------

Skiptipunktar / Hnútpunktar
~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Við nefnum :math:`x_j` *skiptipunkta* eða *hnútpunkta* skiptingarinnar.
...
Við reiknum út nálgun á réttu lausninni :math:`y(x)` í hnútpunktunum.
...
Skipt á afleiðum og mismunakvótum
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Óþekktar stærðir og hægri hlið
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Línulegar jöfnur – Blönduð jaðarskilyrði
----------------------------------------
...
hugsum við okkur að við bætum einum punkti :math:`x_{-1}=a-h` við og
...
Jöfnur fyrir gildin í endapunktum
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
